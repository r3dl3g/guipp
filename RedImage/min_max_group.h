...
class min_max_group : public gui::win::group_window<gui::layout::horizontal_lineup<52>, gui::color::very_very_light_gray> {
public:
  typedef gui::win::group_window<gui::layout::horizontal_lineup<52>, gui::color::very_very_light_gray> super;
