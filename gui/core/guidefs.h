...
namespace gui {
  ...
  enum class pixel_format_t : int {
    ...
    RGBA      = IF_SDL_ELSE(SDL_PIXELFORMAT_RGBA32,     5),
    BGRA      = IF_SDL_ELSE(SDL_PIXELFORMAT_BGRA32,     6),
    ARGB      = IF_SDL_ELSE(SDL_PIXELFORMAT_ARGB32,     7),
    ABGR      = IF_SDL_ELSE(SDL_PIXELFORMAT_ABGR32,     8)
  };
