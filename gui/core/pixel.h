...
namespace gui {
  ...
  namespace pixel {
    ...
    template<>
    struct GUIPP_CORE_EXPORT mono_colors<false> {
      static constexpr mono value[2] = {mono::white, mono::black};
    };

    template<>
    struct GUIPP_CORE_EXPORT mono_colors<true> {
...
#pragma pack(pop)
    ...
    // --------------------------------------------------------------------------
    template<typename T> struct is_bit_type : public std::false_type {};
    template<typename T> struct is_byte_type : public std::false_type {};
    ...
    template<> struct is_bit_type<mono> : public std::true_type {};
    template<> struct is_byte_type<gray> : public std::true_type {};
    ...
    // --------------------------------------------------------------------------
    template<>
    struct GUIPP_CORE_EXPORT color<mono> {
    ...
    // --------------------------------------------------------------------------
    template<>
    struct GUIPP_CORE_EXPORT color<gray> {
    ...
    // --------------------------------------------------------------------------
    template<>
    struct GUIPP_CORE_EXPORT color<rgb> {
    ...
    // --------------------------------------------------------------------------
    template<>
    struct GUIPP_CORE_EXPORT color<rgba> {
    ...
    // --------------------------------------------------------------------------
    template<>
    struct GUIPP_CORE_EXPORT color<bgr> {
    ...
    // --------------------------------------------------------------------------
    template<>
    struct GUIPP_CORE_EXPORT color<bgra> {
    ...
    // --------------------------------------------------------------------------
    template<>
    struct GUIPP_CORE_EXPORT color<argb> {
    ...
    // --------------------------------------------------------------------------
    template<>
    struct GUIPP_CORE_EXPORT color<abgr> {
      static constexpr abgr black = {0, 0, 0, 0};
      static constexpr abgr white = {0, 0xff, 0xff, 0xff};
    };

    // --------------------------------------------------------------------------
    GUIPP_CORE_EXPORT std::ostream& operator<< (std::ostream& out, const mono&);
    GUIPP_CORE_EXPORT std::ostream& operator<< (std::ostream& out, const gray&);
    GUIPP_CORE_EXPORT std::ostream& operator<< (std::ostream& out, const rgb&);
    GUIPP_CORE_EXPORT std::ostream& operator<< (std::ostream& out, const rgba&);
    GUIPP_CORE_EXPORT std::ostream& operator<< (std::ostream& out, const bgr&);
    GUIPP_CORE_EXPORT std::ostream& operator<< (std::ostream& out, const bgra&);
    GUIPP_CORE_EXPORT std::ostream& operator<< (std::ostream& out, const argb&);
    GUIPP_CORE_EXPORT std::ostream& operator<< (std::ostream& out, const abgr&);
    ...
    // --------------------------------------------------------------------------
    GUIPP_CORE_EXPORT mono operator+ (const mono&, const mono&);
    GUIPP_CORE_EXPORT gray operator+ (const gray&, const gray&);
