...
namespace gui {
  ...
  namespace win {
    ...
    template<text_origin align, draw::frame::drawer frame, os::color foreground, os::color background, os::color bar_color>
    ...
    inline void basic_progress_bar<A, D, F, B, C>::init () {
      register_event_handler(REGISTER_FUNCTION, paint_event(this, &basic_progress_bar::paint));
    }
