...
namespace gui {
  ...
  namespace io {
    ...
    template<>
    struct PNM2BPP<PNM::P1> {static constexpr BPP bpp = BPP::BW;
    };
    template<>
    struct PNM2BPP<PNM::P2> {static constexpr BPP bpp = BPP::GRAY;
    };
    template<>
    struct PNM2BPP<PNM::P3> {static constexpr BPP bpp = BPP::RGB;
    };
    template<>
    struct PNM2BPP<PNM::P4> {static constexpr BPP bpp = BPP::BW;
    };
    template<>
    struct PNM2BPP<PNM::P5> {static constexpr BPP bpp = BPP::GRAY;
    };
    template<>
    struct PNM2BPP<PNM::P6> {static constexpr BPP bpp = BPP::RGB;
    };
    ...
    template<>
    struct BPP2PNM<BPP::BW, false>   {static constexpr PNM pnm = PNM::P1;
    };
    template<>
    struct BPP2PNM<BPP::GRAY, false> {static constexpr PNM pnm = PNM::P2;
    };
    template<>
    struct BPP2PNM<BPP::RGB, false>  {static constexpr PNM pnm = PNM::P3;
    };
    template<>
    struct BPP2PNM<BPP::RGBA, false> {static constexpr PNM pnm = PNM::P3;
    };

    template<>
    struct BPP2PNM<BPP::BW, true>    {static constexpr PNM pnm = PNM::P4;
    };
    template<>
    struct BPP2PNM<BPP::GRAY, true>  {static constexpr PNM pnm = PNM::P5;
    };
    template<>
    struct BPP2PNM<BPP::RGB, true>   {static constexpr PNM pnm = PNM::P6;
    };
    template<>
    struct BPP2PNM<BPP::RGBA, true>  {static constexpr PNM pnm = PNM::P6;
    };
