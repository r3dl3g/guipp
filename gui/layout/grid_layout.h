...
namespace gui {
  ...
  namespace layout {
    ...
    public:
      ...
      grid_lineup () = default;
      grid_lineup (const std::vector<layout_element>& list);
    ...
    public:
      ...
      fixed_grid_lineup (const std::vector<layout_element>& list);
    ...
    public:
      ...
      grid_adaption (const std::vector<layout_element>& list);
