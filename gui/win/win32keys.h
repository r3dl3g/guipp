...
namespace gui {
  ...
  namespace win {
    ...
    namespace keys {
      ...
      const os::key_symbol a = 'A';
      const os::key_symbol b = 'B';
      const os::key_symbol c = 'C';
      const os::key_symbol d = 'D';
      const os::key_symbol e = 'E';
      const os::key_symbol f = 'F';
      const os::key_symbol g = 'G';
      const os::key_symbol h = 'H';
      const os::key_symbol i = 'I';
      const os::key_symbol j = 'J';
      const os::key_symbol k = 'K';
      const os::key_symbol l = 'L';
      const os::key_symbol m = 'M';
      const os::key_symbol n = 'N';
      const os::key_symbol o = 'O';
      const os::key_symbol p = 'P';
      const os::key_symbol q = 'Q';
      const os::key_symbol r = 'R';
      const os::key_symbol s = 'S';
      const os::key_symbol t = 'T';
      const os::key_symbol u = 'U';
      const os::key_symbol v = 'V';
      const os::key_symbol w = 'W';
      const os::key_symbol x = 'X';
      const os::key_symbol y = 'Y';
      const os::key_symbol z = 'Z';
