...
// --------------------------------------------------------------------------
namespace std {
  ostream& operator<< (ostream&, const raspi::core::four_cc&);
  istream& operator>> (istream&, raspi::core::four_cc&);
  ostream& operator<< (ostream&, const raspi::core::crop&);
  istream& operator>> (istream&, raspi::core::crop&);
