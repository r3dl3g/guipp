...
DEFINE_TEST(test_draw_line_0x0) {
  ...
  EXPECT_EQUAL(buffer, MM({{R, _, _, _, _},
                           {_, R, _, _, _},
                           {_, _, _, _, _},
                           {_, _, _, _, _},
                           {_, _, _, _, _}}));
...
DEFINE_TEST(test_draw_line_top_right_2) {
  ...
  EXPECT_EQUAL(buffer, MM({{_, _, _, _, R},
                           {_, _, _, R, _},
                           {_, _, R, _, _},
                           {_, _, _, _, _},
                           {_, _, _, _, _}}));
...
DEFINE_TEST(test_frame_ellipse_4x4) {
  ...
  EXPECT_EQUAL(buffer, MM({{_, R, R, R, _},
                           {R, _, _, _, R},
                           {R, _, _, _, R},
                           {R, _, _, _, R},
                           {_, R, R, R, _}}));
...
DEFINE_TEST(test_frame_ellipse_3x3) {
  ...
  EXPECT_EQUAL(buffer, MM({{_, R, R, _, _},
                           {R, _, _, R, _},
                           {R, _, _, R, _},
                           {_, R, R, _, _},
                           {_, _, _, _, _}}));
...
DEFINE_TEST(test_frame_ellipse_2x2) {
  ...
  auto buffer = pixmap2colormap(img);
  EXPECT_EQUAL(buffer, MM({{R, R, R, _, _},
                           {R, _, R, _, _},
                           {R, R, R, _, _},
                           {_, _, _, _, _},
                           {_, _, _, _, _}}));
...
DEFINE_TEST(test_frame_ellipse_1x1) {
  ...
  EXPECT_EQUAL(buffer, MM({{R, R, _, _, _},
                           {R, R, _, _, _},
                           {_, _, _, _, _},
                           {_, _, _, _, _},
                           {_, _, _, _, _}}));
...
DEFINE_TEST(test_frame_round_rectangle_2) {
  ...
  EXPECT_EQUAL(buffer, MM({{_, _, R, R, R, _, _},
                           {_, R, _, _, _, R, _},
                           {R, _, _, _, _, _, R},
                           {R, _, _, _, _, _, R},
                           {R, _, _, _, _, _, R},
...
DEFINE_TEST(test_frame_arc_135_225_2) {
  ...
  EXPECT_EQUAL(buffer, MM({{_, R, _, _, _},
                           {R, _, R, _, _},
                           {R, _, _, R, _},
                           {R, _, R, _, _},
                           {_, R, _, _, _}}));
...
DEFINE_TEST(test_frame_arc_315_405_2) {
  ...
  EXPECT_EQUAL(buffer, MM({{_, _, _, R, _},
                           {_, _, R, _, R},
                           {_, R, _, _, R},
                           {_, _, R, _, R},
                           {_, _, _, R, _}}));
