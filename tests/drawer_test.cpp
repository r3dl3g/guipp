...
void test_data2colormap24 () {
  ...
  std::vector<core::byte> testdata = { 0x00, 0x00, 0x00,    0x00, 0x00, 0x01,    0x00, 0x00, 0x02,    0x00, 0x00, 0x03,    0x00, 0x00, 0x04,    0x00,
...
void test_data2colormap8 () {
  ...
  std::vector<core::byte> testdata = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x00,
...
void test_data2colormap1 () {
  ...
  std::vector<core::byte> testdata = { 0x00, 0x00,
                                       0x1F, 0x00,
                                       0x15, 0x00,
                                       0x0A, 0x00};
...
void test_frame_rect_3x3_x3 () {
  ...
  EXPECT_EQUAL(buffer, CM({
                            {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_},
                            {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,R,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,R,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,R,_,_,_,_},
                            {_,_,R,R,R,_,_,_,R,R,R,_,_,_,_},
                            {_,_,R,R,R,_,_,_,R,R,R,_,_,_,_},
                            {_,_,R,R,R,_,_,_,R,R,R,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,R,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,R,_,_,_,_},
...
void test_frame_rect_3x3_x4 () {
  ...
  EXPECT_EQUAL(buffer, CM({
                            {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_},
                            {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,R,R,R,R,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,R,R,R,R,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,R,R,R,R,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,R,R,R,R,_,_,_,_,_,_},
                            {_,_,R,R,R,R,_,_,_,_,R,R,R,R,_,_,_,_,_,_},
                            {_,_,R,R,R,R,_,_,_,_,R,R,R,R,_,_,_,_,_,_},
                            {_,_,R,R,R,R,_,_,_,_,R,R,R,R,_,_,_,_,_,_},
                            {_,_,R,R,R,R,_,_,_,_,R,R,R,R,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,R,R,R,R,_,_,_,_,_,_},
...
void test_frame_rect_2x2_x4 () {
  ...
  EXPECT_EQUAL(buffer, CM({
                            {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_},
                            {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,_,_,_,_,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,_,_,_,_,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,_,_,_,_,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,_,_,_,_,_,_,_,_,_,_},
                            {_,_,R,R,R,R,R,R,R,R,_,_,_,_,_,_,_,_,_,_},
...
void test_line (float scale, int sz, const core::point& p1, const core::point& p2, colormap&& expected) {
  ...
  graphics g(img);
  g.clear(color::black);
  draw::line(p1, p2)(g, draw::pen(color::red, 1, pen::Style::solid, pen::Cap::square, pen::Join::round));
  auto buffer = pixmap2colormap(img);
  EXPECT_EQUAL(buffer, expected, " from (", p1.x(), ", ", p1.y(), ") to (", p2.x(), ", ", p2.y(), ")");
...
void test_frame_ellipse_4x4_x3 () {
  tester<draw::ellipse>(3.0F, 21, {1, 1}, {5, 5}, CM({
    ...
    {_,_,_,R,R,R,_,_,_,_,_,_,_,_,_,R,R,R,_,_,_},
    {_,_,_,_,R,R,R,_,_,_,_,_,_,_,R,R,R,_,_,_,_},
    {_,_,_,_,R,R,R,R,R,R,_,R,R,R,R,R,R,_,_,_,_},
    {_,_,_,_,_,R,R,R,R,R,R,R,R,R,R,R,_,_,_,_,_},
    {_,_,_,_,_,_,_,R,R,R,R,R,R,R,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_},
...
void test_draw_ellipse_4x4_3 () {
  tester2<draw::ellipse, color::blue, color::red>(3.0F, 21, {1, 1}, {5, 5}, CM({
    ...
    {_,_,_,R,R,R,B,B,B,B,B,B,B,B,B,R,R,R,_,_,_},
    {_,_,_,_,R,R,R,B,B,B,B,B,B,B,R,R,R,_,_,_,_},
    {_,_,_,_,R,R,R,R,R,R,B,R,R,R,R,R,R,_,_,_,_},
    {_,_,_,_,_,R,R,R,R,R,R,R,R,R,R,R,_,_,_,_,_},
    {_,_,_,_,_,_,_,R,R,R,R,R,R,R,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_},
